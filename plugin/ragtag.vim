...
augroup ragtag
  ...
  autocmd FileType javascript,javascript.jsx,jsx,javascriptreact,handlebars  call s:Init()
  autocmd FileType typescript,typescript.tsx,tsx,typescriptreact             call s:Init()
